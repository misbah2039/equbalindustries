export const coreServices = [
  {
    title: "Construction Service IEI",
    description: "Construction and site-level execution support services.",
  },
  {
    title: "Ex- Building Construction",
    description: "Building construction and expansion work support.",
  },
  {
    title: "HVAC Plumbing",
    description: "Heating, cooling, and plumbing installation and maintenance.",
  },
  {
    title: "Car Repair Services",
    description: "Automotive maintenance, diagnostics, and service support.",
  },
];
...
export const industries = [
  {
    ...
    text: "Fleet maintenance and reliability-focused service support.",
  },
  {
    name: "Construction and Infrastructure",
    text: "Heavy usage vehicle servicing with preventive maintenance planning.",
  },
  {
    name: "Manufacturing Units",
    text: "Dedicated service cycles for industrial mobility and operations.",
  },
  {
    name: "Corporate and Institutions",
    text: "Professional car care packages for office and institutional fleets.",
  },
];
